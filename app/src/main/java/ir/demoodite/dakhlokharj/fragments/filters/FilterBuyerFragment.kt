...
@AndroidEntryPoint
class FilterBuyerFragment : Fragment() {
    private var _binding: FragmentFilterBuyerBinding? = null
    ...
    override fun onCreateView(
        ...
        _binding = FragmentFilterBuyerBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
